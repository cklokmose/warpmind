...
async function runRealAPITests() {
  ...
  try {
    ...
    const response = await ai.ask(
      'Explain the concept of machine learning in simple terms for a beginner.'
    );
    console.log('✅ Success!');
  ...
  try {
    ...
    console.log(
      '✅ Success! Recalled memories semantically related to "primary color of the sky":'
    );
    console.log(results);
    console.log('');
  } catch (error) {
...
async function testTTS() {
  ...
  try {
    const audioBlob = await ai.textToSpeech(
