...
describe('API Authentication Tests', () => {
  ...
  test('textToSpeech should use api-key header', async () => {
  ...
  test('speechToText should use api-key header', async () => {
  ...
  test('chat should use api-key header', async () => {
    fetch.mockResolvedValue({
      ok: true,
  ...
  test('streamChat should use api-key header', async () => {
