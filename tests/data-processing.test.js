...
describe('WarpMind Data Processing Module Tests', () => {
  ...
  describe('process() method', () => {
    ...
    it('should process string data correctly', async () => {
      ...
      const result = await mind.process('Summarize this text', 'This is a test string', {
    ...
    it('should process without data parameter', async () => {
      ...
      const result = await mind.process('Generate random data', null, {
    ...
    it('should handle JSON parsing errors with retries', async () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Process attempt 1 failed:'));
    ...
    it('should fail after maximum retries with proper error logging', async () => {
      ...
      await expect(
        mind.process('Generate JSON', null, { field: 'description' }, { retries: 1 })
    ...
    it('should handle HTTP errors properly', async () => {
      ...
      mind.chat = jest
        ...
        .mockRejectedValueOnce(
          new Error('API request failed: 500 Internal Server Error. Server error')
        )
        .mockRejectedValueOnce(
          new Error('API request failed: 500 Internal Server Error. Server error')
        )
      ...
      await expect(mind.process('Test prompt', null, { result: 'test' })).rejects.toThrow(
        /API request failed: 500 Internal Server Error|All process attempts failed/
      );
    ...
    it('should handle array data input', async () => {
      ...
      await mind.process('Count items', arrayData, { count: 'Number of items' });
    ...
    it('should handle object data input', async () => {
      ...
      await mind.process('Process object', objectData, {
    ...
    it('should include retry delay between attempts', async () => {
      ...
      await mind.process('Test', null, { success: 'result' }, { retries: 1 });
